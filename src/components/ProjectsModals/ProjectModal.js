...
const ProjectModal = ({ state, details, toggleModal }) => {
  return state ? (
    <div className="fixed inset-0 h-screen w-full bg-black/25 p-4 backdrop-blur z-[9999999] flex items-center justify-center">
      <MdClose
        onClick={toggleModal}
